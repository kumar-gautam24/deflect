...
Written by hand for the same reason as 0002: autogenerate proposes dropping the
generated `text_search` column, which the ORM deliberately does not declare.
"""
